    ...
    return (
      <div className="min-h-screen flex items-center justify-center text-center px-4 pt-20">
        <div>
          ...
          <Link
            href="/"
            className="bg-brand-pink text-white font-bold px-6 py-3 rounded-full hover:bg-brand-pink/90 transition-colors"
          >
            {t.common.back}
          </Link>
        </div>
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            {event.google_maps_embed ? (
              ...
              <a
                ...
                className="flex items-center gap-3 bg-gradient-card rounded-2xl p-5 border border-brand-wine/40 hover:border-brand-pink/40 transition-colors group"
              >
                ...
                <div>
                  <p className="text-white font-semibold text-sm group-hover:text-brand-pink transition-colors">
                    {t.nextRun.directions}
                  </p>
                  <p className="text-white/50 text-xs">{location}</p>
                </div>
                <svg className="w-4 h-4 text-white/30 ml-auto group-hover:text-brand-pink transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
