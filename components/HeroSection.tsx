  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto pt-20">
        ...
        {/* Subtitle */}
        <p className="text-white/70 text-lg sm:text-xl max-w-2xl mx-auto mb-10 animate-slide-up">
          {t.hero.subtitle}
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in">
          <Link
            href="/next-run"
            className="bg-brand-pink text-white font-bold text-base px-8 py-4 rounded-full hover:bg-brand-pink/90 hover:scale-105 transition-all duration-200 shadow-lg shadow-brand-pink/30"
          >
            {t.hero.cta}
          </Link>
          <Link
            href="/login"
            className="border border-white/30 text-white font-semibold text-base px-8 py-4 rounded-full hover:border-white hover:bg-white/10 transition-all duration-200"
          >
            {t.hero.joinUs}
          </Link>
        </div>
